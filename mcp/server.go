...
func Serve(f *policy.File, policyPath string) error {
	...
	s.AddTool(runTool, makeRunHandler(f, policyPath))
...
func makeRunHandler(f *policy.File, policyPath string) func(context.Context, mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
